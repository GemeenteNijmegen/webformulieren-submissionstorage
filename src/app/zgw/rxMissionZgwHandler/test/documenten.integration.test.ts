    ...
    try {
      ...
      if (fileBuffer) {
        ...
        const informatieObject = {
          url: 'https://documenten.preprod-rx-services.nl/api/v1/enkelvoudiginformatieobjecten/fc1db34d-0bc0-43a0-8365-fa3c17e262ad',
        };
        const lock = '2013437807ee47688d375a9a39d0e5dc';
        const bestandsDeelUrl = 'https://documenten.preprod-rx-services.nl/api/v1/bestandsdelen/03b00ce1-ad74-44c7-b07f-6264667172a4';
        ...
        if (bestandsDeelUrl && lock) {
          ...
          if (result.url) {
            //TODO Gaat mis op url: https://documenten.preprod-rx-services.nl/api/v1/https://documenten.preprod-rx-services.nl/api/v1/enkelvoudiginformatieobjecten/fc1db34d-0bc0-43a0-8365-fa3c17e262ad/unlock
