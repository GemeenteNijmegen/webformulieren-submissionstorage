...
/**
 * An AWS Lambda function which executes src/app/get-form-overview/getFormOverview.
 */
export class GetFormOverviewFunction extends lambda.Function {
  constructor(scope: Construct, id: string, props?: GetFormOverviewFunctionProps) {
    super(scope, id, {
      description: 'src/app/get-form-overview/getFormOverview.lambda.ts',
      ...props,
      runtime: new lambda.Runtime('nodejs20.x', lambda.RuntimeFamily.NODEJS),
      handler: 'index.handler',
      code: lambda.Code.fromAsset(path.join(__dirname, '../../../assets/app/get-form-overview/getFormOverview.lambda')),
    });
